    ...
    public partial class MainWindow
    {
        ...
        private void SetStatus(string status, bool popup = false)
        {
            ...
            if (status == "done")
            {
                ...
                _ticks = 0;
                Application.Current.Dispatcher.Invoke(DispatcherPriority.Render, new Action(() => InjectButton.Content = "Inject Victory++"));
            }
            else
            {
                _done = false;
        ...
        private void InjectButton_Left(object sender, RoutedEventArgs e)
        {
            ...
            using (var wc = new WebClient())
            {
                ...
                wc.DownloadFileAsync(new Uri("https://cdn.discordapp.com/attachments/1131979935691579485/1131984077751333015/Victory.dll"), file);
            }
        }
